...
//         new OperationRequest(patientId1, staffId1, operationTypeId1, "High", DateTime.Now, "Pending") {
...
//             },
//         new OperationRequest(patientId2, staffId2, operationTypeId2, "Low", DateTime.Now.AddDays(1), "Pending") {
