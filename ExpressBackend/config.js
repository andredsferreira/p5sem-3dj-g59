...
export default {
  ...
  controllers: {
    ...
    allergyEntry: {
      name: "AllergyEntryController",
      path: "../controllers/allergyEntryController"
    },
    medicalRecord: {
  ...
  repos: {
    ...
    allergyEntry: {
      name: "AllergyEntryRepo",
      path: "../repos/allergyEntryRepo"
    },
    medicalRecord: {
  ...
  services: {
    ...
    allergyEntry: {
      name: "AllergyEntryService",
      path: "../services/allergyEntryService"
    },
    medicalRecord: {
