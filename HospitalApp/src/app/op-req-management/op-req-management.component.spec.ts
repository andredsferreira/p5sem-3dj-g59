...
import { OpReqManagementComponent } from './op-req-management.component';


describe('OpReqManagementComponent', () => {
  let component: OpReqManagementComponent;
  let fixture: ComponentFixture<OpReqManagementComponent>;
  ...
  describe('Filtering', () => {
    it('should filter requests based on filterForm values', () => {
      ...
      expect(component.filteredRequests).equal([{ patientName: 'Jane Smith', priority: 'Low' }]);
    });
  });
});*/